...
class ImportTest < ActiveSupport::TestCase
  ...
  test 'force_publish! will create and enqueue a new ImportForcePublicationAttemptWorker job' do
    Sidekiq::Testing.fake! do
      ...
      assert_equal 1, ImportForcePublicationAttemptWorker.jobs.size
    end
  end
  ...
  test 'most_recent_force_publication_attempt is the last created ForcePublicationAttempt' do
    Sidekiq::Testing.fake! do
      ...
      assert_equal 3, import.force_publication_attempts.size
  ...
  test "#destroy also destroys all imported documents" do
    ...
    documents.each do |imported_doc|
      assert_equal nil, Document.find_by(id: imported_doc.id)
    end
  end
  ...
  test "#destroy also destroys the import logs" do
    ...
    logs.each do |import_log|
      assert_equal nil, ImportLog.find_by(id: import_log.id)
    end
  end
  ...
  test "#destroy also destroys force publication attempts" do
    ...
    import.destroy
    assert_equal nil, ForcePublicationAttempt.find_by(id: force_attempt.id)
  end
